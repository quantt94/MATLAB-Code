...
for i = [1:3 5];
    ...
    title('PORTFOLIO VALUE OVER THE YEARS 2008 AND 2009','FontSize', 18);
    xlabel('Dates','FontWeight','bold','FontSize',14);
    ylabel('Portfolio Value (in Millions)', 'FontWeight','bold','FontSize',14);
    lgd = legend('Buy and Hold','Equally Weighted','Minimum Variance','Equal Risk Contributions','location','southwest');
